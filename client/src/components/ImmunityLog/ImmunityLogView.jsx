...
const ImmunityLogView = () => {
  ...
  return (
    <ViewFirstBox openDrawer={openDrawer}>
      ...
      >
        <ImmunityLogTable immunityLogData={immunityLogData} immunityLogSuccess={immunityLogSuccess} handleOpenActionMenu={handleOpenActionMenu}/>
      </Box>
      <NewImmunityLogModal
      ...
      <ImmunityLogActionMenu selectedRow={selectedRow} refetchImmunityLog={refetchImmunityLog} actionAnchor={actionAnchor} isActionMenuOpen={isActionMenuOpen} handleCloseActionMenu={handleCloseActionMenu}/>
    </ViewFirstBox>
  );
};
